...
('Host', 6, 'Julia Hoffmann', 'julia.hoffmann@email.de', '+491706666666', '$2b$12$P2aWqc3G97j6rYX...'),
('Host', 7, 'Jonas Fischer', 'jonas.fischer@email.de', '+491707777777', '$2b$12$Q3bXqd4H88k7sZY...'),
('Host', 8, 'Sarah Meyer', 'sarah.meyer@email.de', '+491708888888', '$2b$12$R4cYqe5I99l8tAZ...'),
('Host', 9, 'Felix Bauer', 'felix.bauer@email.de', '+491709999999', '$2b$12$S5dZrf6J00m9uBA...'),
('Host', 10, 'Emma Richter', 'emma.richter@email.de', '+491701010101', '$2b$12$T6eAsg7K11n0vCB...'),
('Local', 11, 'David Schulz', 'david.schulz@email.de', '+491701212121', '$2b$12$U7fBth8L22o1wDC...'),
('Local', 12, 'Marie Krause', 'marie.krause@email.de', '+491701313131', '$2b$12$V8gCui9M33p2xED...'),
('Local', 13, 'Simon Kohler', 'simon.kohler@email.de', '+491701414141', '$2b$12$W9hDvj0N44q3yFE...'),
('Local', 14, 'Elena Vogt', 'elena.vogt@email.de', '+491701515151', '$2b$12$X0iEwk1O55r4zGF...'),
('Local', 15, 'Paul Werner', 'paul.werner@email.de', '+491701616161', '$2b$12$Y1jFxl2P66s5aHG...'),
('Local', 16, 'Clara Fuchs', 'clara.fuchs@email.de', '+491701717171', '$2b$12$Z2kGym3Q77t6bIH...'),
('Local', 17, 'Ben Schwarz', 'ben.schwarz@email.de', '+491701818181', '$2b$12$A3lHzn4R88u7cJI...'),
('Local', 18, 'Lea Hahn', 'lea.hahn@email.de', '+491701919191', '$2b$12$B4mIao5S99v8dKJ...'),
('Local', 19, 'Noah Wolf', 'noah.wolf@email.de', '+491702020202', '$2b$12$C5nJbp6T00w9eLK...'),
('Local', 20, 'Mia Berger', 'mia.berger@email.de', '+491702121212', '$2b$12$D6oKcq7U11x0fML...');
...
INSERT INTO "Experience_Block_Dates" ("Experience_Listing_ID", "Experience_Calendar_ID", "Exp_Blocked_Date") VALUES
(1, 1, '2026-12-24'),
(2, 2, '2026-12-25'),
(3, 3, '2026-12-26'),
(4, 4, '2026-12-31'),
