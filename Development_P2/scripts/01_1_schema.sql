...
CREATE TABLE "Notifications" (
  ...
  -- Domain Rule for (the above) OFK: Prevents booking from processing without at least 1 service, e.g. either Booking_ID or Experience_Booking_ID, depending on service booked by Guest
