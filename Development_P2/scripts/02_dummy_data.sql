...
INSERT INTO "User" ("User_Type", "User_Type_ID", "User_Name", "User_Email", "User_Phone", "Password_Hash") VALUES
('Host', 1, 'Max Mustermann', 'max.mustermann@email.de', '+491701111111', '$2b$12$K7vRnx8B92e1mWS...'),
('Host', 2, 'Anna Schmidt', 'anna.schmidt@email.de', '+491702222222', '$2b$12$L8wSny9C93f2nXT...'),
('Host', 3, 'Lukas Weber', 'lukas.weber@email.de', '+491703333333', '$2b$12$M9xTnz0D94g3oYU...'),
('Host', 4, 'Laura Wagner', 'laura.wagner@email.de', '+491704444444', '$2b$12$N0yUoa1E95h4pZV...'),
('Host', 5, 'Tim Becker', 'tim.becker@email.de', '+491705555555', '$2b$12$O1zVpb2F96i5qXW...'),
('Local', 6, 'Julia Hoffmann', 'julia.hoffmann@email.de', '+491706666666', '$2b$12$P2aWqc3G97j6rYX...'),
('Local', 7, 'Jonas Fischer', 'jonas.fischer@email.de', '+491707777777', '$2b$12$Q3bXqd4H88k7sZY...'),
('Local', 8, 'Sarah Meyer', 'sarah.meyer@email.de', '+491708888888', '$2b$12$R4cYqe5I99l8tAZ...'),
('Local', 9, 'Felix Bauer', 'felix.bauer@email.de', '+491709999999', '$2b$12$S5dZrf6J00m9uBA...'),
('Local', 10, 'Emma Richter', 'emma.richter@email.de', '+491701010101', '$2b$12$T6eAsg7K11n0vCB...'),
('Guest', 11, 'David Schulz', 'david.schulz@email.de', '+491701212121', '$2b$12$U7fBth8L22o1wDC...'),
('Guest', 12, 'Marie Krause', 'marie.krause@email.de', '+491701313131', '$2b$12$V8gCui9M33p2xED...'),
('Guest', 13, 'Simon Kohler', 'simon.kohler@email.de', '+491701414141', '$2b$12$W9hDvj0N44q3yFE...'),
('Guest', 14, 'Elena Vogt', 'elena.vogt@email.de', '+491701515151', '$2b$12$X0iEwk1O55r4zGF...'),
('Guest', 15, 'Paul Werner', 'paul.werner@email.de', '+491701616161', '$2b$12$Y1jFxl2P66s5aHG...'),
('Guest', 16, 'Clara Fuchs', 'clara.fuchs@email.de', '+491701717171', '$2b$12$Z2kGym3Q77t6bIH...'),
('Guest', 17, 'Ben Schwarz', 'ben.schwarz@email.de', '+491701818181', '$2b$12$A3lHzn4R88u7cJI...'),
('Guest', 18, 'Lea Hahn', 'lea.hahn@email.de', '+491701919191', '$2b$12$B4mIao5S99v8dKJ...'),
('Guest', 19, 'Noah Wolf', 'noah.wolf@email.de', '+491702020202', '$2b$12$C5nJbp6T00w9eLK...'),
('Guest', 20, 'Mia Berger', 'mia.berger@email.de', '+491702121212', '$2b$12$D6oKcq7U11x0fML...');
...
--  5.  "Social_Media_Connection" Records
...
--  6.  "Accommodation_Listing" Records
...
--  10.1.  "Property_Block_Dates" Records

INSERT INTO "Property_Block_Dates" ("Property_ID", "Prop_Blocked_Date") VALUES
(1, '2026-11-01'),
(2, '2026-11-02'),
(3, '2026-11-03'),
(4, '2026-11-04'),
...
--  10.2.  "Property_Calendar" Records
...
--  10.3.  "Accommodation_Booking" Records
...
--  11.1.  "Experience_Block_Dates" Records
...
--  11.2.  "Experience_Calendar" Records
...
--  11.3.  "Experience_Booking" Records
